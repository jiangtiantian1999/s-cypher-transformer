...
class TestMatch(TestCase):
    ...
    def test_match_12(self):
        s_cypher = 'MATCH (n:Person) BETWEEN interval("1940", NOW) RETURN n.name limit 10;'
        cypher_query = transform_to_cypher(s_cypher)
        print("test_match_12:", '\n', s_cypher, '\n\n', cypher_query, '\n\n')

    def test_match_13(self):
        s_cypher = 'MATCH (n:Person @T("1690", NOW)) BETWEEN interval("1940", NOW) RETURN n.name'
        cypher_query = transform_to_cypher(s_cypher)
        print("test_match_13:", '\n', s_cypher, '\n\n', cypher_query, '\n\n')

    def test_match_14(self):
        s_cypher = 'MATCH (n:Person @T("1960", NOW)) BETWEEN interval("1940", NOW) RETURN n.name'
        cypher_query = transform_to_cypher(s_cypher)
        print("test_match_14:", '\n', s_cypher, '\n\n', cypher_query, '\n\n')
